...
const BulkCreateModal = <FormValues extends FieldValues, RowValues extends FieldValues>({
  ...
  const { control, handleSubmit, reset, setValue, formState } = useForm<FormValues>({
    defaultValues: createDefaultValues() as DefaultValues<FormValues>,
    mode: 'onChange',
  });
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      const ok = await onSubmitForm(data as FormValues);
      if (ok) handleClose();
    } finally {
        ...
        >
          ...
          <AddRowBar
            ...
            onClick={() => {
              ...
              (append as unknown as (value: RowValues) => void)(createRow());
            }}
          />
