...
jest.mock('@/components/Section/Section', () => ({ title, action, children }: any) => (
  <section>
    <h2>{title}</h2>
    {action}
    {children}
...
jest.mock('@/components/TeamLogo/TeamLogo', () => () => <span data-testid="team-logo" />);
...
jest.mock('@/components/ConfirmModal/ConfirmModal', () => () => <div />);
